...
const EXPERIENCES = {
    rent: {
        title: 'Office for Rent in JLT Dubai | Cushman & Wakefield Core',
        description: 'Find office space for rent in JLT with Cushman & Wakefield Core. Share your requirements and let our commercial team shortlist suitable options.',
        kicker: 'JLT Offices for Rent',
        heroTitle: 'Office for Rent<br>in JLT Dubai',
        heroText: 'Find office space for rent in JLT with options shaped around your team, timing and preferred fit-out.',
        pointOneTitle: 'Connected business district',
        pointOneText: 'Explore an office for rent in Jumeirah Lake Towers close to metro links and everyday amenities.',
        pointTwoTitle: 'A broad range of options',
        pointTwoText: 'Compare fitted, furnished and shell-and-core workplaces across selected towers.',
        pointThreeTitle: 'A focused shortlist',
        pointThreeText: 'Review the office for rent JLT market with independent commercial guidance.',
        formKicker: 'JLT Rental Enquiry',
        formTitle: 'Find an Office to Rent',
        formSubject: 'New JLT office rental enquiry',
        enquiryType: 'JLT — Office rental enquiry',
        timelineLabel: 'Preferred Move-In (optional)',
        timelinePlaceholder: 'Select timeline',
        submitLabel: 'Request a Rental Shortlist',
        sectionKicker: 'JLT Leasing Advantages',
        sectionTitle: 'Flexible offices for different business needs.',
        sectionIntro: 'From compact workplaces to full-floor requirements, JLT offers different specifications and facilities to compare.',
        ...
        supportIntro: 'Tell us what matters to your business, including whether you are considering one JLT office for rent, and we will help you compare suitable options.',
        ...
        finalTitle: 'Ready to find your next JLT office?',
        finalCta: 'Enquire About Offices for Rent'
    },
    sale: {
        title: 'Office for Sale in JLT | Cushman & Wakefield Core',
        description: 'Review offices for sale in JLT Dubai with Cushman & Wakefield Core. Share your purchase requirements and let our commercial team shortlist suitable opportunities.',
        kicker: 'JLT Offices for Sale',
        heroTitle: 'Office for Sale<br>in JLT',
        heroText: 'Review office for sale in JLT Dubai with commercial guidance shaped around your business or investment requirements.',
        pointOneTitle: 'Established business location',
        pointOneText: 'Consider offices in a well-connected district with metro access and a wide range of amenities.',
        pointTwoTitle: 'Different ownership options',
        pointTwoText: 'Compare unit sizes, fit-out conditions and selected full-floor opportunities across JLT.',
        pointThreeTitle: 'Informed decision-making',
        pointThreeText: 'Assess building quality, service charges, occupancy considerations and transaction terms.',
        formKicker: 'JLT Sales Enquiry',
        formTitle: 'Find an Office to Buy',
        formSubject: 'New JLT office sales enquiry',
        enquiryType: 'JLT — Office sales enquiry',
        timelineLabel: 'Preferred Purchase Timeline (optional)',
        timelinePlaceholder: 'Select timeline',
        submitLabel: 'Request a Sales Shortlist',
        sectionKicker: 'JLT Ownership Opportunities',
        ...
        supportIntro: 'Share your priorities and our commercial team will help you compare offices for sale in JLT Dubai.',
        ...
        finalTitle: 'Ready to explore JLT offices for sale?',
    ...
    form?.addEventListener('submit', async event => {
        ...
        try {
            ...
            if (typeof fbq === 'function') {
                fbq('track', 'Lead', { content_name: 'JLT Rent-Sale', content_category: currentIntent });
            }
            ...
            if (leadCard) {
                leadCard.innerHTML = `
                    <div class="success-card">
                        ...
                        <p>Thank you. Our commercial team will contact you about JLT office
                            ${currentIntent === 'sale' ? 'purchase' : 'rental'} options.</p>
                        <div class="mini-location"><span>JLT, Dubai</span></div>
                    </div>
                `;
            }
        } catch {
