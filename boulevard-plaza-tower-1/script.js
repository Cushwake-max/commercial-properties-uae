...
// with each lead (visible in the lead email; gclid enables exact
// keyword lookup via the Google Ads API). Invisible to the visitor.
// ====================================================================
(function () {
...
// ====================================================================
// CW CORE LANDING PAGE TEMPLATE — script.js
// Only edit the CONFIG block below. Everything else is shared behavior
// and must stay identical across all property landing pages.
// ====================================================================

// --------------------------------------------------------------------
// CONFIG — EDIT THESE VALUES PER PROPERTY
// --------------------------------------------------------------------
const PROPERTY_CONFIG = {
    // Property display name, used in the enquiry success message
    propertyName: 'Boulevard Plaza Tower 1',
    // Short area label, e.g. 'JLT, Dubai'
    areaShort: 'Downtown Dubai',
    // Direct URL to the hosted brochure PDF (opens after the brochure form is submitted).
    // Tip: upload the PDF to the property's GitHub repo and use the raw.githubusercontent.com link.
    brochureUrl: ''
};
// --------------------------------------------------------------------
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (destCards.length) {
        selectDestination(destCards[0].dataset.id);
    }
            ...
            try {
                ...
                leadCard.innerHTML = `
                    <div class="success-card">
                        ...
                        <p>Thank you for your interest in ${PROPERTY_CONFIG.propertyName}. Our commercial team at Cushman & Wakefield Core will contact you within 24 hours.</p>
                        <div class="mini-location" style="margin-top: 15px;">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                            <span>${PROPERTY_CONFIG.propertyName} &bull; ${PROPERTY_CONFIG.areaShort}</span>
                        </div>
                    </div>
                `;
            } catch (err) {
    ...
    const brochureUrl = PROPERTY_CONFIG.brochureUrl;
